...
tpc.Walk As P_Walk,
tpc.Ground_Out AS P_GB,
tpc.Fly_Out AS P_FB,
tpc.Sac_Fly AS P_Sac_Fly,
pc.startingPitcher,
...
NULLIF(SUM(ft2.Strikeout),0) AS K,
...
NULLIF(SUM(ft2.P_atBat),0) AS P_atBat,
NULLIF(SUM(ft2.P_Sac_Fly),0) AS P_Sac_Fly,
NULLIF(SUM(ft2.P_Hit),0) AS P_Hit,
NULLIF(SUM(ft2.P_GB),0) AS P_GB,
NULLIF(SUM(ft2.P_FB),0) AS P_FB,
...
SELECT 
	...
	ROUND(((rdh.P_Hit-rdh.P_Home_Run)/(rdh.P_atBat-rdh.P_K-rdh.P_Home_Run+rdh.P_Sac_Fly))/((rda.P_Hit-rda.P_Home_Run)/(rda.P_atBat-rda.P_K-rda.P_Home_Run+rda.P_Sac_Fly)),5) AS P_BABIP_Ratio,
    ...
    ROUND(((((rdh.Hit+rdh.BB+rdh.Hit_By_Pitch)/(rdh.atBat+rdh.BB+rdh.Sac_Fly+rdh.Hit_By_Pitch))+(rdh.TB/rdh.atBat))
	/(((rda.Hit+rda.BB+rda.Hit_By_Pitch)/(rda.atBat+rda.BB+rda.Sac_Fly+rda.Hit_By_Pitch))+(rda.TB/rda.atBat))),5) AS OPS_Ratio,
    ...
    ROUNd((((rdh.P_GB)/(rdh.P_FB))/((rda.P_GB)/(rda.P_FB))),5) AS GBF_Ratio,
...
#OPS = (((H+BB+HBP)/(AB+BB+Sac_Fly+HBP))+(TB/AB))
...
SELECT 
	...
	ROUND(((rdh.P_Hit-rdh.P_Home_Run)/(rdh.P_atBat-rdh.P_K-rdh.P_Home_Run+rdh.P_Sac_Fly))
	-((rda.P_Hit-rda.P_Home_Run)/(rda.P_atBat-rda.P_K-rda.P_Home_Run+rda.P_Sac_Fly)),5) AS P_BABIP_diff,
	ROUND((((rdh.Hit + rdh.BB + rdh.Hit_By_Pitch) / (rdh.atBat + rdh.BB + rdh.Hit_By_Pitch + rdh.Sac_Fly))
	...
	ROUND(((((rdh.Hit+rdh.BB+rdh.Hit_By_Pitch)/(rdh.atBat+rdh.BB+rdh.Sac_Fly+rdh.Hit_By_Pitch))+(rdh.TB/rdh.atBat))
	-(((rda.Hit+rda.BB+rda.Hit_By_Pitch)/(rda.atBat+rda.BB+rda.Sac_Fly+rda.Hit_By_Pitch))+(rda.TB/rda.atBat))),5) AS OPS_diff,
	...
	ROUNd((((rdh.P_GB)/(rdh.P_FB))-((rda.P_GB)/(rda.P_FB))),5) AS GBF_diff,
	...
	-(3.00+((13*rda.P_Home_Run)+(3*(rdh.BB+rda.P_Hit_By_Pitch))-(2*rda.P_K))/rdh.P_IP),5) AS DICE_diff,
...
SELECT 
	...
	ROUND(((((rdh.P_Hit-rdh.P_Home_Run)/(rdh.P_atBat-rdh.P_K-rdh.P_Home_Run+rdh.P_Sac_Fly))-((rda.P_Hit-rda.P_Home_Run)/(rda.P_atBat-rda.P_K-rda.P_Home_Run+rda.P_Sac_Fly)))/((rdh.P_Hit-rdh.P_Home_Run)/(rdh.P_atBat-rdh.P_K-rdh.P_Home_Run+rdh.P_Sac_Fly))),5) AS P_BABIP_per,
	ROUND(((((rdh.Hit + rdh.BB + rdh.Hit_By_Pitch) / (rdh.atBat + rdh.BB + rdh.Hit_By_Pitch + rdh.Sac_Fly))
	...
	ROUND((((rdh.`2B`+rdh.`3B`+rdh.Home_Run)-(rda.`2B`+rda.`3B`+rda.Home_Run))/(rdh.`2B`+rdh.`3B`+rdh.Home_Run))*100,5) AS XBH_diff,
	ROUND(((rdh.TB - rda.TB)/rdh.TB+0.0001)*100,3) AS TB_per,
	ROUND(((rdh.TOB - rda.TOB)/rdh.TOB+0.0001)*100,5) AS TOB_per,
	ROUND((((((rdh.Hit+rdh.BB+rdh.Hit_By_Pitch)/(rdh.atBat+rdh.BB+rdh.Sac_Fly+rdh.Hit_By_Pitch))+(rdh.TB/rdh.atBat))
	-(((rda.Hit+rda.BB+rda.Hit_By_Pitch)/(rda.atBat+rda.BB+rda.Sac_Fly+rda.Hit_By_Pitch))+(rda.TB/rda.atBat)))
	/(((rdh.Hit+rdh.BB+rdh.Hit_By_Pitch)/(rdh.atBat+rdh.BB+rdh.Sac_Fly+rdh.Hit_By_Pitch))+(rdh.TB/rdh.atBat)))*100,5) AS OPS_per,
	ROUND(((rdh.P_IP-rda.P_IP)/rdh.P_IP+0.0001)*100,5) AS IP_per,
	ROUND(((((((13*rdh.P_Home_Run)+(3*rdh.P_BB)-(2*rdh.P_K))/(rdh.P_IP+0.0001))-(((13*rda.P_Home_Run)+(3*rda.P_BB)-(2*rda.P_K))/(rda.P_IP+0.0001))))/(((13*rdh.P_Home_Run+0.0001)+(3*rdh.P_BB)-(2*rdh.P_K))/(rdh.P_IP+0.0001)))*100,5) AS FIP_per,
	...
	ROUNd(((((rdh.P_GB)/(rdh.P_FB))-((rda.P_GB)/(rda.P_FB)))/((rdh.P_GB)/(rdh.P_FB))),5) AS GBF_per,
	ROUND(((rdh.ERA - nullif(rda.ERA,0))/(rdh.ERA+0.0001))*100,5) AS ERA_per,
	ROUND((((3.00+((13*rdh.P_Home_Run)+(3*(rdh.P_BB+rdh.P_Hit_By_Pitch))-(2*rdh.P_K))/rdh.P_IP)-(3.00+((13*rda.P_Home_Run)+(3*(rdh.BB+rda.P_Hit_By_Pitch))-(2*rda.P_K))/rdh.P_IP))/(3.00+((13*rdh.P_Home_Run)+(3*(rdh.P_BB+rdh.P_Hit_By_Pitch))-(2*rdh.P_K))/rdh.P_IP))*100,5) AS DICE_per,
	ROUND(((((rdh.P_Avg_Home_Run)/rdh.P_IP)-((rda.P_Avg_Home_Run)/rda.P_IP))/((rdh.P_Avg_Home_Run)/rdh.P_IP))*100,5) AS HR9_per,
	ROUND(((((rdh.P_Home_Run + rdh.P_BB) / rdh.P_IP)-((rda.P_Home_Run + rda.P_BB) / rda.P_IP))/((rdh.P_Home_Run + rdh.P_BB) / (rdh.P_IP+0.0001)))*100,5) AS WHIP_per,
